...
public class AddBookToStore extends AddMediaToStore {
	public AddBookToStore(Cart cart, Store store) {
		super(cart, store);
	...
	JPanel createCenter(Cart cart) {
        ...
        JLabel lblAuthors = new JLabel("List authors: (seperated ',')");
        ...
        btnAdd.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(this, "Add book secesstly", "Success", JOptionPane.INFORMATION_MESSAGE);
